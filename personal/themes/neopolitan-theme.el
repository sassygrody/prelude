...
(custom-theme-set-faces
 ...
 '(hl-line ((t (:background "#5d5550"))))

 '(message-header-subject ((t (:foreground "SkyBlue"))))

 '(minibuffer-prompt ((t (:background "#271F19" :foreground "#FBDE2D" :box (:line-width -1 :color "#271F19") :bold Weight))))
